...
public class TaskScheduleApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaginatedResponse getTaskSchedules(String userId, String companyId) throws ApiException {
    ApiResponse<PaginatedResponse> localVarResponse = getTaskSchedulesWithHttpInfo(userId, companyId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PaginatedResponse> getTaskSchedulesWithHttpInfo(String userId, String companyId) throws ApiException {
