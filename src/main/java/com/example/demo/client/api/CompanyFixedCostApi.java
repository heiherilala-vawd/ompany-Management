...
public class CompanyFixedCostApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaginatedResponse getCompanyFixedCosts(String userId, String companyId) throws ApiException {
    ApiResponse<PaginatedResponse> localVarResponse = getCompanyFixedCostsWithHttpInfo(userId, companyId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PaginatedResponse> getCompanyFixedCostsWithHttpInfo(String userId, String companyId) throws ApiException {
