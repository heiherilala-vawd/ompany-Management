...
public class CashTransactionMapper {
  ...
  public com.example.demo.model.money.CashTransaction toDomain(CrupdateCashTransaction rest) {
    ...
    return com.example.demo.model.money.CashTransaction.builder()
        ...
        .type(
            EnumMapper.mapEnum(
                rest.getType(), com.example.demo.model.money.CashTransaction.TransactionType.class))
        .comment(rest.getComment())
        .build();
  }

  public CashTransaction toRestCashTransaction(
      com.example.demo.model.money.CashTransaction domain) {
  ...
  public List<CashTransaction> toRestCashTransactions(
      List<com.example.demo.model.money.CashTransaction> domains) {
