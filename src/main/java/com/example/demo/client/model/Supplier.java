...
@JsonPropertyOrder({
  ...
  Supplier.JSON_PROPERTY_COMPANY_ID,
...
public class Supplier {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, siret, address, email, phone, contactName, companyId, createdAt, updatedAt, createdBy, updatedBy, comment);
  }
